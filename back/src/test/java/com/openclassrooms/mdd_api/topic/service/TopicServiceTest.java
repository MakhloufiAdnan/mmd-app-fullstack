...
class TopicServiceTest {
    ...
    void listTopics_sortsAndFlagsSubscribed() {
        ...
        assertThat(res).containsExactly(
                new TopicListItemDto(1L, "Java", false),
                new TopicListItemDto(2L, "Spring", true)
        );
    }
    ...
    void listTopics_allUnsubscribed_whenNoSubscriptions() {
        ...
        when(t.getName()).thenReturn("Java");

        when(topicRepository.findAll(any(Sort.class))).thenReturn(List.of(t));
        ...
        // Assert
        assertThat(res).containsExactly(new TopicListItemDto(1L, "Java", false));
    }
}
